...
function sass () {
  ...
  let sassVariable = agartha.read.text(agartha.path.join(agartha.appDir(), 'app/sass', '_bootstrap-variables.scss'))
  sassVariable = sassVariable.replace(re, stringReplacement)
  agartha.write(agartha.path.join(agartha.appDir(), 'app/sass', '_bootstrap-variables.scss'), sassVariable, 'utf8', () => {
